/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 2579a4e8add3d867afaa71786a4dc28e)
// Runtime types generated with workerd@1.20260907.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ResearchAgent: DurableObjectNamespace<import("./src/server").ResearchAgent>;
	RESEARCH_WORKFLOW: Workflow<Parameters<import("./src/server").ResearchWorkflow['run']>[0]['payload']>;
}
